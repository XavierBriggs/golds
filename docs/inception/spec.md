...
| R7 | DONE 2026-07-19: formal Breakout 100-ep deterministic unclipped eval, mean 265.21 (median 376, best 382, max 415), above the >=250 gate and at published PPO level (ref 274.8). Reproducible: git_sha 74f4ef8, git_dirty=False. eval_100ep + human_normalized (9.15x, superhuman as expected for Breakout) populated. | G3, G4 |
